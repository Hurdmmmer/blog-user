...
import com.youjian.blog.user.utils.BindingResultExceptionHandler;
...
public class UserspaceController {
    ...
    public ResponseEntity<ResponseResult> saveAvatar(@PathVariable("username") String username, @RequestBody User user) {
        ...
        return ResponseEntity.ok().body(ResponseResult.success("处理成功", avatarUrl));
    }
    ...
    public String listBlogsByOrder(@PathVariable("username") String username,
        ...
        if (order.equals("hot")) { // 最热查询
            ...
            page = blogService.listBlogsByTileVoteAndSort(user, keyword, pageable);
        }
    ...
    public ResponseEntity<ResponseResult> deleteBlog(@PathVariable("username") String username,@PathVariable("id") Long id) {
        ...
        return ResponseEntity.ok().body(ResponseResult.success("处理成功", redirectUrl));
    }
    ...
    public ResponseEntity<ResponseResult> saveBlog(@PathVariable("username") String username, @RequestBody Blog blog) {
        ...
        try {
            ...
            return ResponseEntity.ok().body(ResponseResult.fail(BindingResultExceptionHandler.getMessage(e)));
        } catch (Exception e) {
            return ResponseEntity.ok().body(ResponseResult.fail(e.getMessage()));
        }
